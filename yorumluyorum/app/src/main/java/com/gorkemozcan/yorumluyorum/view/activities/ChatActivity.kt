...
import com.gorkemozcan.yorumluyorum.adapter.ChatItemAdapter
import com.gorkemozcan.yorumluyorum.databinding.ActivityChatBinding
...
import com.gorkemozcan.yorumluyorum.service.NotificationModel
import com.gorkemozcan.yorumluyorum.service.PushNotification
import com.gorkemozcan.yorumluyorum.service.Retrofit
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bundle?.let {
            bundle.apply {
                ...
                Glide.with(applicationContext).load(user.photoURL).into(binding.ivItemProfilePicChat)
            }
        }
        ...
        binding.textInputMessageLayout.setEndIconOnClickListener {
            ...
            val title = "Message from ${currentUser.userName}"
    ...
    private fun sendNotification(notification : PushNotification) = CoroutineScope(Dispatchers.IO).launch {
        try{
            ...
            Toast.makeText(applicationContext, "Bir hata meydana geldi tekrar deneyiniz",Toast.LENGTH_SHORT).show()
        }
    }
